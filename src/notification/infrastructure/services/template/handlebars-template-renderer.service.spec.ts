...
describe('HandlebarsTemplateRendererService', () => {
  ...
  describe('render', () => {
    ...
    it('throws NotificationError with TEMPLATE_NOT_FOUND code for unknown template', async () => {
      await expect(sut.render('unknown/template', {})).rejects.toBeInstanceOf(NotificationError);
    });

    describe('real templates', () => {
      const templatesExist = fs.existsSync(templatesDir);

      (templatesExist ? it : it.skip)('renders welcome template without error', async () => {
      ...
      (templatesExist ? it : it.skip)('renders password-reset template without error', async () => {
      ...
      (templatesExist ? it : it.skip)('renders password-changed template without error', async () => {
      ...
      (templatesExist ? it : it.skip)('renders password-reset-completed template without error', async () => {
      ...
      (templatesExist ? it : it.skip)('caches compiled templates on second call', async () => {
        const context = {
          appName: 'TestApp',
          appDomain: 'test.com',
          firstName: 'John',
